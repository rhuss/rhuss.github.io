...
As soon as Google Blog post ["Introducing Jib — build Java Docker images better"](https://cloudplatform.googleblog.com/2018/07/introducing-jib-build-java-docker-images-better.html) went online, all my channels went crazy about [Jib][jib].
